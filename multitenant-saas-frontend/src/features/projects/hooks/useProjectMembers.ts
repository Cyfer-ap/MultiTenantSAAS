...
export const projectMembersQueryKeys = {
    ...
    list: (
        ...
        ...projectMembersQueryKeys.project(
            tenantId,
            projectId,
        ),
        params,
...
export function useProjectMembers(
    ...
    return useQuery({
        queryKey: projectMembersQueryKeys.list(
            tenantId,
            projectId,
            params,
        ),
...
function useInvalidateProjectMembers(
    tenantId: string,
    projectId: string,
) {
    ...
    return async (): Promise<void> => {
        await queryClient.invalidateQueries({
            queryKey: projectMembersQueryKeys.project(
                tenantId,
                projectId,
            ),
        })
...
export function useUpdateProjectMemberRole(
    ...
    return useMutation({
        mutationFn: ({
            userId,
            input,
        }: MemberMutationInput<UpdateProjectMemberRoleInput>) =>
...
export function useRemoveProjectMember(
    ...
    return useMutation({
        mutationFn: (userId: string) =>
            projectMembersApi.removeMember(
                tenantId,
                projectId,
                userId,
            ),
