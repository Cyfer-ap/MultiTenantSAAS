...
export const projectTasksQueryKeys = {
    ...
    list: (
        ...
        ...projectTasksQueryKeys.project(tenantId, projectId),
        params,
    ] as const,
}
...
export function useProjectTasks(
    ...
    return useQuery({
        queryKey: projectTasksQueryKeys.list(
            tenantId,
            projectId,
            params,
        ),
...
function useInvalidateProjectTasks(
    tenantId: string,
    projectId: string,
) {
    ...
    return async (): Promise<void> => {
        await queryClient.invalidateQueries({
            queryKey: projectTasksQueryKeys.project(
                tenantId,
                projectId,
            ),
        })
...
export function useUpdateProjectTask(
    ...
    return useMutation({
        mutationFn: ({
            taskId,
            input,
        }: TaskMutationInput<ProjectTaskDetailsInput>) =>
            projectTasksApi.updateTask(
                tenantId,
                projectId,
                taskId,
                input,
...
export function useUpdateProjectTaskStatus(
    ...
    return useMutation({
        mutationFn: ({
            taskId,
            input,
        }: TaskMutationInput<UpdateProjectTaskStatusInput>) =>
            projectTasksApi.updateTaskStatus(
                tenantId,
                projectId,
                taskId,
                input,
...
export function useUpdateProjectTaskAssignee(
    tenantId: string,
    projectId: string,
) {
    const invalidate = useInvalidateProjectTasks(
    ...
    return useMutation({
        mutationFn: ({
            taskId,
            input,
        }: TaskMutationInput<UpdateProjectTaskAssigneeInput>) =>
            projectTasksApi.updateTaskAssignee(
                tenantId,
                projectId,
                taskId,
                input,
