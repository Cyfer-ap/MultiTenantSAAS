...
export function AuthProvider({ children }: PropsWithChildren) {
    ...
    useEffect(
        () =>
            authStorage.subscribe((storedSession) => {
                if (storedSession) {
    ...
    useEffect(() => {
        ...
        async function restoreSession() {
            ...
            try {
                const currentUser: CurrentUserResponse = await authApi.getCurrentUser()

                const validatedSession = authStorage.read()
                ...
                commitSession(applyCurrentUser(validatedSession, currentUser))
            } catch (error: unknown) {
