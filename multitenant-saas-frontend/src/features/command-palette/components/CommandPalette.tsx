...
import { CreateInvitationDialog } from '../../invitations/components/InvitationDialogs'
import { CreateProjectDialog } from '../../projects/components/ProjectManagementDialogs'
import { useGlobalSearch } from '../../search/hooks/useGlobalSearch'
import type { GlobalSearchResult, GlobalSearchResultType } from '../../search/types/search'
...
type PaletteAction = 'CREATE_PROJECT' | 'INVITE_USER'
