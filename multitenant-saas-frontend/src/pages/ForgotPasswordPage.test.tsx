...
describe('ForgotPasswordPage', () => {
    ...
    it('normalizes the request and exposes the development reset link', async () => {
        ...
        const forgotPassword = vi
            .spyOn(passwordResetApi, 'forgotPassword')
            .mockResolvedValue({
        ...
        const resetLink = await screen.findByLabelText(
            /reset link/i,
        ) as HTMLInputElement
        ...
        expect(resetLink.value).toMatch(
            /\/reset-password\?token=one-time-reset-token$/,
        )
    })
})
