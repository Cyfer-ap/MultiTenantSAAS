...
class GlobalExceptionHandlerDataIntegrityTest {
    ...
    void unknownIntegrityViolationRemainsInternalServerError() {
        ...
        ResponseEntity<ApiErrorResponse> response =
                exceptionHandler.handleDataIntegrityViolationException(
                        exception,
                        request
                );
    ...
    private ResponseEntity<ApiErrorResponse> handleConstraint(
        ...
        return exceptionHandler.handleDataIntegrityViolationException(
                exception,
                request
        );
    }
