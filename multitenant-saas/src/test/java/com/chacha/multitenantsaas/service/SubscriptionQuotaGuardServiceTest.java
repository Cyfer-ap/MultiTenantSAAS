...
class SubscriptionQuotaGuardServiceTest {
    ...
    @BeforeEach
    void setUp() {
        guardService = new SubscriptionQuotaGuardService(
                entitlementService,
                tenantSubscriptionRepository,
                true
        );
    ...
    void rejectsProjectCreationWhenLimitIsReached() {
        ...
        assertThat(exception.getRestrictionType())
                .isEqualTo(RestrictionType.PROJECT_LIMIT_REACHED);
    }
    ...
    void rejectsGrowthWhenSubscriptionMutationsAreBlocked() {
        ...
        assertThat(exception.getRestrictionType())
                .isEqualTo(RestrictionType.SERVICE_UNAVAILABLE);
        assertThat(exception.getAccessReason())
                .isEqualTo(SubscriptionAccessReason.CANCELLED);
    }
    ...
    private ResourceEntitlement resource(
            long used,
            Long limit,
