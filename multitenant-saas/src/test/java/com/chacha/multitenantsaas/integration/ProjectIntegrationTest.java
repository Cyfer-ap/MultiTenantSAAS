...
class ProjectIntegrationTest {
    ...
    @Test
    void tenantAdminCanManageCompleteProjectLifecycle()
            throws Exception {

        TenantFixture tenant =
                onboardUniqueTenant("project-admin");
        ...
        ProjectFixture project = createProject(
                tenant.tenantId(),
                adminToken,
                "Customer Portal",
        ...
        mockMvc.perform(
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.name")
                        .value("Customer Management Portal"))
    ...
    @Test
    void projectListSupportsSearchStatusFilterAndPagination()
            throws Exception {

        TenantFixture tenant =
                onboardUniqueTenant("project-filter");
        ...
        ProjectFixture customerProject = createProject(
                tenant.tenantId(),
                adminToken,
                "Customer Portal",
    ...
    @Test
    void tenantManagerCanCreateAndUpdateProjects()
            throws Exception {

        TenantFixture tenant =
                onboardUniqueTenant("project-manager");
        ...
        mockMvc.perform(
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.name")
                        .value("Updated Manager Project"))
                .andExpect(jsonPath("$.data.createdByUserEmail")
                        .value(manager.email()));
    }

    @Test
    void tenantUserCanReadProjectsButCannotModifyThem()
            throws Exception {

        TenantFixture tenant =
                onboardUniqueTenant("project-user");
    ...
    @Test
    void tenantCannotAccessAnotherTenantsProjects()
            throws Exception {

        TenantFixture tenantA =
                onboardUniqueTenant("project-tenant-a");

        TenantFixture tenantB =
                onboardUniqueTenant("project-tenant-b");
        ...
        ProjectFixture tenantBProject = createProject(
                tenantB.tenantId(),
                tenantBToken,
                "Tenant B Project",
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.errorCode")
                        .value("ACCESS_DENIED"))
                .andExpect(jsonPath("$.path")
                        .value(expectedProjectPath));
    }

    @Test
    void archivedProjectCannotBeModifiedOrArchivedAgain()
            throws Exception {

        TenantFixture tenant =
                onboardUniqueTenant("project-archive");
