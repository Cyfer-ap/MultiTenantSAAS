...
class SubscriptionApiIntegrationTest {
    ...
    private static final String SYSTEM_ADMIN_EMAIL =
            "system.test@saas.local";

    private static final String SYSTEM_ADMIN_PASSWORD =
            "TestSystemAdmin@123";
    ...
    @Autowired
    private PlatformAuditLogRepository
    ...
    @Test
    void systemAdminManagesPlansAndTenantReadsSubscription()
            throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.data.plan.id")
                        .value(starterPlanId.toString()))
                .andExpect(jsonPath("$.data.status")
                        .value("ACTIVE"));

        String tenantToken = loginTenantAdmin(
                tenantId,
    ...
    @Test
    void systemSubscriptionApisRejectMissingAuthentication()
            throws Exception {
    ...
    private String loginTenantAdmin(
            UUID tenantId,
            String email
    ) throws Exception {
        MvcResult result =
    ...
    private String readAccessToken(MvcResult result)
            throws Exception {
        JsonNode body =
                jsonMapper.readTree(
                        result.getResponse()
