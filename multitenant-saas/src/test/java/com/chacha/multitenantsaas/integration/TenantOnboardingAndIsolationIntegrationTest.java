...
class TenantOnboardingAndIsolationIntegrationTest {
    ...
    @Test
    void publicOnboardingCreatesActiveTenantAndTenantAdmin()
            throws Exception {
    ...
    @Test
    void duplicateTenantSlugReturnsConflict()
            throws Exception {
        ...
        onboardTenant(
                "First Duplicate Tenant",
                tenantSlug,
                "first." + suffix + "@example.test"
        );

        String secondRequest = onboardingRequest(
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.path")
                        .value("/api/onboarding/tenants"));
    }

    @Test
    void onboardedTenantAdminCanLogin()
            throws Exception {
    ...
    @Test
    void tenantAdminCanAccessOwnTenantUsers()
            throws Exception {
    ...
    @Test
    void tenantAdminCannotAccessAnotherTenantsUsers()
            throws Exception {
    ...
    @Test
    void tenantUserCannotLoginThroughAnotherTenant()
            throws Exception {
    ...
    private TenantFixture onboardTenant(
            String tenantName,
            String tenantSlug,
            String adminEmail
    ) throws Exception {

        String requestBody = onboardingRequest(
                tenantName,
                tenantSlug,
                adminEmail
        );
        ...
        MvcResult result = mockMvc.perform(
                ...
                .andExpect(jsonPath("$.data.tenant.slug")
                        .value(tenantSlug))
                .andExpect(jsonPath("$.data.tenant.status")
                        .value("ACTIVE"))
                .andExpect(jsonPath("$.data.adminUser.email")
                        .value(adminEmail))
                .andExpect(jsonPath("$.data.adminUser.role")
                        .value("TENANT_ADMIN"))
                .andExpect(jsonPath("$.data.adminUser.status")
                        .value("ACTIVE"))
                .andReturn();
    ...
    private String login(TenantFixture tenant)
            throws Exception {
    ...
    private String onboardingRequest(
            String tenantName,
            String tenantSlug,
            String adminEmail
    ) {
