...
class AuthorizationManagementAndAuditV2IntegrationTest {
    ...
    @Test
    void delegatedAuthorizationManagerCanUseManagementApi()
            throws Exception {
    ...
    @Test
    void delegatedAuditorCanReadAuditButNotManageRoles()
            throws Exception {
    ...
    @Test
    void selfScopedAuditorReadsOnlyOwnAuditLogs()
            throws Exception {
         ...
         */
        String selfAuditorToken =
                login(
                        context.tenant().getId(),
                        selfAuditor.getEmail()
                );
    ...
    @Test
    void v2AssignmentPreventsLegacyAdminBypass()
            throws Exception {
