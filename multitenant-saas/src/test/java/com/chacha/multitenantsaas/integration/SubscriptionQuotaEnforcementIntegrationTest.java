...
class SubscriptionQuotaEnforcementIntegrationTest {
    ...
    @Test
    void enforcesQuotaGrowthAndStillAllowsCleanup()
            throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.details.used")
                        .value("3"))
                .andExpect(jsonPath("$.details.limit")
                        .value("3"));

        String invitationToken = createInvitation(
                tenant.tenantId(),
                adminToken
        );
    ...
    private TenantFixture onboardTenant() throws Exception {
        ...
        String adminEmail =
                "quota.admin." + suffix + "@example.test";
    ...
    private String createInvitation(
        ...
        return response.at("/data/devInvitationToken")
                .asString();
    }
