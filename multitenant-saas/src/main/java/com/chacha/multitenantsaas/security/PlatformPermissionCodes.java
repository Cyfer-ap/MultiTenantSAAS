...
public final class PlatformPermissionCodes {
    ...
    public static final String ORGANIZATION_UNIT_READ = "organization.unit.read";

    public static final String ORGANIZATION_UNIT_MANAGE = "organization.unit.manage";

    public static final String ORGANIZATION_ASSIGNMENT_READ = "organization.assignment.read";

    public static final String ORGANIZATION_ASSIGNMENT_MANAGE = "organization.assignment.manage";
