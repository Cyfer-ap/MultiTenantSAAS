...
public interface PersonalWorkspaceItemRepository
    ...
    Optional<PersonalWorkspaceItem> findByTenant_IdAndUser_IdAndResourceTypeAndResourceId(
            UUID tenantId, UUID userId, PersonalResourceType resourceType, UUID resourceId);
