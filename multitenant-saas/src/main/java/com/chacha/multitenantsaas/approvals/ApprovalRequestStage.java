...
public class ApprovalRequestStage {
    ...
    @Column(name = "stage_key", nullable = false, length = 64) private String stageKey;
    @Column(name = "stage_name", nullable = false, length = 120) private String stageName;
    @Column(name = "position_index", nullable = false) private int positionIndex;
    @Column(name = "allow_requester_approval", nullable = false) private boolean allowRequesterApproval;
    @Enumerated(EnumType.STRING) @Column(nullable = false, length = 20) private ApprovalStageStatus status;
    ...
    public void activate() { status = ApprovalStageStatus.PENDING; }
    public void decide(UUID actorUserId, ApprovalDecisionOutcome outcome, String comment) {
        ...
        status = outcome == ApprovalDecisionOutcome.APPROVE
