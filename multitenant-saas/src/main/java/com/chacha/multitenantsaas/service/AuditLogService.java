...
public class AuditLogService {
    ...
    public void record(
            Tenant tenant, AppUser user, AuditAction action, boolean success, String message) {
        record(tenant, user, user, action, success, message);
    }
    ...
    public void record(
            ...
            boolean success,
            String message) {
        AuditLog auditLog = new AuditLog(tenant, actorUser, targetUser, action, success, message);
    ...
    public void recordSystemAdmin(
            ...
            String message) {
        AuditLog auditLog =
                new AuditLog(tenant, actorSystemAdmin, targetUser, action, success, message);
    ...
    public void recordSuccess(
            ...
            AuditAction action,
            String message) {
        record(tenant, actorUser, targetUser, action, true, message);
    }
    ...
    public void recordFailure(
            ...
            AuditAction action,
            String message) {
        record(tenant, actorUser, targetUser, action, false, message);
    }

    public void recordSelfSuccess(Tenant tenant, AppUser user, AuditAction action, String message) {
        recordSuccess(tenant, user, user, action, message);
    }

    public void recordSelfFailure(Tenant tenant, AppUser user, AuditAction action, String message) {
    ...
    public void recordSystemAdminSuccess(
            ...
            AuditAction action,
            String message) {
        recordSystemAdmin(tenant, actorSystemAdmin, targetUser, action, true, message);
    }
    ...
    public PageResponse<AuditLogResponse> getAuditLogsByTenant(
        ...
        Page<AuditLog> auditLogs =
                auditLogRepository.findTenantAuditLogs(tenantId, action, success, pageable);
    ...
    public PageResponse<AuditLogResponse> getAuditLogsByTenantAndUser(
        ...
        Page<AuditLog> auditLogs =
                auditLogRepository.findUserAuditLogs(tenantId, userId, action, success, pageable);
