...
public class SubscriptionPlanService {
    ...
    public SubscriptionPlanResponse createPlan(
        ...
        if (subscriptionPlanRepository.existsByCode(code)) {
            throw new DuplicateResourceException(
                    "Subscription plan already exists with code: "
                            + code
            );
        }
    ...
    @Transactional
    public SubscriptionPlanResponse changeStatus(
            UUID planId,
        ...
        plan.setStatus(
                requireValue(status, "Subscription plan status")
        );
    ...
    public List<SubscriptionPlanResponse> getPlans(
        ...
        List<SubscriptionPlan> plans = activeOnly
                ...
                : subscriptionPlanRepository
                .findAllByOrderByPriceAscCodeAsc();
    ...
    private String normalizeCode(String value) {
        ...
        if (!normalized.matches("[A-Z0-9_]+")) {
            throw new IllegalArgumentException(
                    "Plan code may contain letters, numbers, "
    ...
    private Integer normalizeLimit(
            Integer value,
            String fieldName
    ) {
