...
public class UserInvitationController {
    ...
    public ResponseEntity<
            ApiResponse<PageResponse<UserInvitationDetailsResponse>>
    ...
    public ResponseEntity<ApiResponse<UserInvitationDetailsResponse>>
    getInvitationById(
            @PathVariable UUID tenantId,
            @PathVariable UUID invitationId
    ) {
        UserInvitationDetailsResponse response =
                userInvitationService.getInvitationById(
                        tenantId,
                        invitationId
                );
        ...
        return ResponseEntity.ok(
                ApiResponse.success(
                        "User invitation fetched successfully",
                        response
                )
        );
    }
    ...
    revokeInvitation(
        ...
        UserInvitationDetailsResponse response =
                userInvitationService.revokeInvitation(
                        tenantId,
                        invitationId,
                        jwt
                );
    ...
    public ResponseEntity<ApiResponse<UserInvitationAcceptResponse>>
    acceptInvitation(
            @Valid @RequestBody
