...
@RestController
@Tag(name = "System Dashboard", description = "System-level summary APIs")
...
public class DashboardController {
    ...
    @Operation(
            ...
            description =
                    "Returns total tenant and user counts grouped by status. Only system admins can access this endpoint.")
