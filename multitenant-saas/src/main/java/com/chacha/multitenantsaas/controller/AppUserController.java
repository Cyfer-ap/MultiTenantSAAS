...
@Tag(
        name = "Tenant Users",
        description =
                "User management APIs inside a tenant"
)
...
public class AppUserController {
    ...
    @Operation(
            ...
            description =
                    "Creates a user inside an authorized "
                            + "tenant."
    )
    @PreAuthorize(
    ...
    public ResponseEntity<
            ApiResponse<PageResponse<AppUserResponse>>
            >
    getUsersByTenant(
            @PathVariable UUID tenantId,
        ...
        PageResponse<AppUserResponse> users =
                appUserService.getUsersByTenant(
                        tenantId,
                        role,
                        status,
                        search,
    ...
    @Operation(
            ...
            description =
                    "Returns one user when the caller has "
    ...
    @Operation(
            ...
            description =
                    "Updates a user when the caller has "
    ...
    @Operation(
            ...
            description = "Deactivates a tenant user."
    )
    @PreAuthorize(
            "@authorizationSecurity"
                    + ".hasUserPermission("
    ...
    unlockUserLogin(
        ...
        return ResponseEntity.ok(
                ApiResponse.success(
                        "User login unlocked successfully",
                        user
                )
        );
    }
